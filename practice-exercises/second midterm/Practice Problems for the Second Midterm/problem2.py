...
def return_int_function(dataset):
    d=[]
    for row in dataset:
        r=[]
        for e in row:
...
if __name__ == '__main__':
    ...
    dataset = [['1', '35', '12', '5', '1', '100', '0'], ['1', '29', '7', '5', '1', '96', '1'],
               ...
               ['1', '19', '8', '8', '1', '160', '1']]
    dataset=return_int_function(dataset)
    ...
    for i in range(len(test_set)):
        ...
        shouldBe=test_y[i]
        if prediction==shouldBe:
            acc=acc+1
    print(acc/len(test_set))

    input_pred=[float(row) for row in input().split(" ")]


    prediction= classifier.predict([input_pred])[0]
    prediction=int(prediction)
    print(prediction)

    probability=classifier.predict_proba([input_pred])
